...
class DataSourceTests {
	...
	void test3() throws Exception{
		...
		PreparedStatement pstmt = con.prepareStatement("insert into tbl_book values('aaa','aaa','aaa','aaa')");
		pstmt.executeUpdate();
	}
	@Test
	void test4() throws Exception{
		...
		PreparedStatement pstmt = con.prepareStatement("insert into tbl_book values('aaa1','aaa1','aaa1','aaa1')");
		pstmt.executeUpdate();
	}
